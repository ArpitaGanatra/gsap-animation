    ...
    <>
      <div className="flex items-center gap-0.5 absolute left-0.5 top-0.5 right-0.5 w-full pr-1">
        <button
          ...
          className={`z-20 button text-[10px] uppercase flex w-full md:w-fit bg-gray-100 border border-gray-200 items-start gap-x-[2px] rounded-[0.375rem] pl-2.5 pr-10 py-2 pt-10 text-black ${
            !isOpen && pathname === "/"
              ? "text-opacity-[1]"
              : "text-opacity-[0.3]"
